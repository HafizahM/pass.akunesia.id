...
<section class="content-header">
	<div class="content-header-left">
		<h1>View Mail to Group</h1>
	</div>
	<div class="content-header-right">
		<a href="send-mail-group.php" class="btn btn-primary btn-sm">Send Mail to Group</a>
	</div>
</section>
                ...
                foreach ($res as $row) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="all-mail-group-delete.php?id=<?php echo $row['mail_id']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
                        </td>
                    </tr>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="rTable">
                                        ...
                                        <div class="rTableRow">
                                            <div class="rTableHead"><strong>Sent to (Group)</strong></div>
                                            <div class="rTableCell">
                                                <?php
                                                    $j=0;
